...
?>
        ...
        function updateLinks() {
            ...
            links.forEach(function(link) {
              ...
              <div class="btn-group btn-group-sm">
                <a class="btn btn-primary btn-sm mr-2 mb-3 dropdown-item" id="todoscalibres" href="relatorios/habitualidadeTodosCalibres.php?id=<?= $cliente->id ?>" target="_blank">TODOS CALIBRES</a>
              </div>
