...
if (empty($termo)):
	...
	$sql = 'SELECT * FROM tab_membros WHERE bloqueio LIKE "nao" order by matricula';
...
<div class="btn-group btn-group-sm">
<a class="btn btn-info btn-sm" href='relatorios/membros_ativos.php?id=<?=$cliente->id?>' Title="Membros Ativos" alt="Membros Ativos"><i class="fa fa-print" aria-hidden="true"></i></a>
</div>
						  
<div class="btn-group btn-group-sm">
<a class="btn btn-info btn-sm" href='email_renovacao.php?id=<?=$cliente->id?>' Title="Alerta Renova&ccedil;&atilde;o" alt="Alerta Renova&ccedil;&atilde;o"><i class="fa fa-bullhorn" aria-hidden="true"></i></a>
</div>						
