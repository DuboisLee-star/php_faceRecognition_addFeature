...
<br><br><br>
<h4 style="text-align: center;">DECLARAÇÃO DE DESFILIAÇÃO A ENTIDADE DE TIRO DESPORTIVO</h4><br>

<p align=justify style="line-height: 170%; margin-left: 10; margin-right: 10">
'.PDF_TEXTO.', <b>INFORMA</b>, que o FILIADO <B>'.mb_strtoupper($cliente->nome).'</b>, CR nº <B>'.$cliente->cr.'</b>, CPF nº: <B>'.formataCPFCNPJ($cliente->cpf).'</b> e Identidade nº <b>'.formataCPFCNPJ($cliente->identidade).'</b>, foi desligado do nosso quadro de Associados.</p><br>
