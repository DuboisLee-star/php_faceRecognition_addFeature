...
<table border="1" width="100%" bordercolor="#C0C0C0">
  ...
  <tr>
    <td width="26%" align="center">'.$cliente->mens_jan2022.'</td>
    <td width="26%" align="center">'.$cliente->mens_fev2022.'</td>
    <td width="27%" align="center">'.$cliente->mens_mar2022.'</td>
    <td width="27%" align="center">'.$cliente->mens_abr2022.'</td>
    <td width="27%" align="center">'.$cliente->mens_mai2022.'</td>
    <td width="27%" align="center">'.$cliente->mens_jun2022.'</td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="26%" align="center">'.$cliente->mens_jul2022.'</td>
    <td width="26%" align="center">'.$cliente->mens_ago2022.'</td>
    <td width="27%" align="center">'.$cliente->mens_set2022.'</td>
    <td width="27%" align="center">'.$cliente->mens_out2022.'</td>
    <td width="27%" align="center">'.$cliente->mens_nov2022.'</td>
    <td width="27%" align="center">'.$cliente->mens_dez2022.'</td>
  </tr>
</table>
<br><br>

<div align=right>Valor pago pela anuidade foi de <b>'.$cliente->anuidade2022.'.</b>.<br><br></div>
