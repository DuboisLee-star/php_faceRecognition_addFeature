...
$result_transacoes = "SELECT * FROM tab_membros WHERE bloqueio LIKE 'Sim' order by matricula";
...
<h3 style="text-align: center;">RELA&Ccedil;&Atilde;O DE MEMBROS INATIVOS</h3>
