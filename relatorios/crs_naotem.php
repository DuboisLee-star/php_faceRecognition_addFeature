...
$html .= '<th bgcolor="#CCCCCC" width="30%"><div align="center">DATA FILIAÇÃO</th>';
$html .= '</tr>';
$html .= '</thead>';
$html .= '<tbody>';

$resultado_transacoes = "SELECT * FROM tab_membros WHERE bloqueio = 'Nao' AND (cr IS NULL OR cr = '') ORDER BY matricula";
...
while ($row_transacoes = mysqli_fetch_assoc($resultado_transacoes)) {
    ...
    $html .= '<td width="30%"><div align="center">&nbsp;<font size="1">' . date('d/m/Y', strtotime($row_transacoes['data_filiacao'])) . '</td>';
    $html .= '</tr>';
...
<h3 style="text-align: center;">RELA&Ccedil;&Atilde;O DE MEMBROS ATIVOS SEM CR</h3>
