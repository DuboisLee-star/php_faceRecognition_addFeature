...
$mensal = $row_transacoes['mens_jan2021'] + $row_transacoes['mens_fev2021'] + $row_transacoes['mens_mar2021'] + $row_transacoes['mens_abr2021'] + $row_transacoes['mens_mai2021'] + $row_transacoes['mens_jun2021'] + $row_transacoes['mens_jul2021'] + $row_transacoes['mens_ago2021'] + $row_transacoes['mens_set2021'] + $row_transacoes['mens_out2021'] + $row_transacoes['mens_nov2021'] + $row_transacoes['mens_dez2021'];

$html .= '<tr><td>&nbsp;'.$row_transacoes['matricula'] ."</td>";
$html .= '<td>&nbsp;'.$row_transacoes['nome'] ."</td>";
$html .= '<td align="left">'.number_format($row_transacoes['anuidade2021'],2,',','.') . 
" - Anuidade<br>" .number_format($mensal,2,',','.')." - Mensalidades</td></tr>";	

$valor_total += ($row_transacoes['anuidade2021']);

$mensal_total += ($row_transacoes['mens_jan2021']) + ($row_transacoes['mens_fev2021']) + ($row_transacoes['mens_mar2021']) + ($row_transacoes['mens_abr2021']) + ($row_transacoes['mens_mai2021']) + ($row_transacoes['mens_jun2021']) + ($row_transacoes['mens_jul2021']) + ($row_transacoes['mens_ago2021']) + ($row_transacoes['mens_set2021']) + ($row_transacoes['mens_out2021']) + ($row_transacoes['mens_nov2021']) + ($row_transacoes['mens_dez2021']);;

$geral_total += ($row_transacoes['anuidade2021']) + ($row_transacoes['mens_jan2021']) + ($row_transacoes['mens_fev2021']) + ($row_transacoes['mens_mar2021']) + ($row_transacoes['mens_abr2021']) + ($row_transacoes['mens_mai2021']) + ($row_transacoes['mens_jun2021']) + ($row_transacoes['mens_jul2021']) + ($row_transacoes['mens_ago2021']) + ($row_transacoes['mens_set2021']) + ($row_transacoes['mens_out2021']) + ($row_transacoes['mens_nov2021']) + ($row_transacoes['mens_dez2021']);;
...
<h3 style="text-align: center;">RELATÓRIO GERAL VALORES - 2021</h3>
