...
EU, <B>'.utf8_decode($cliente->nome).'</b>, nacionalidade <B>'.utf8_decode($cliente->nacionalidade).'</b>, natural de <B>'.utf8_decode($cliente->naturalidade).'</b>, nascido em <b>'.date('d/m/Y', strtotime($cliente->data_nascimento)).'</b>, profissão <B>'.utf8_decode($cliente->profissao).'</b>, estado civil <B>'.utf8_decode($cliente->estadocivil).'</b>, residente à <B>'.utf8_decode($cliente->rua).'</b> nº <B>'.utf8_decode($cliente->numero).'</b>, bairro <B>'.utf8_decode($cliente->bairro).'</b>, cep: <B>'.utf8_decode($cliente->cep).'</b>, <B>'.utf8_decode($cliente->cidade).'</b>/<B>'.utf8_decode($cliente->siglauf).'</b> e CPF nº <B>'.formataCPFCNPJ($cliente->cpf).'</b>.
