...
$mensal = $row_transacoes['valor_mensalidade'];

$html .= '<tr><td>&nbsp;<font size="2">'.$row_transacoes['matricula'] ."</td>";
$html .= '<td>&nbsp;<font size="2">'.$row_transacoes['nome'] ."</td>";
$html .= '<td align="left">&nbsp;<font size="2">'.number_format($row_transacoes['valor_anuidade'],2,',','.') . 
" - Anuidade<br>&nbsp;" .number_format($mensal,2,',','.')." - Mensalidade</td></tr>";	

$valor_total += ($row_transacoes['valor_anuidade']);

$mensal_total += ($row_transacoes['valor_mensalidade']);

$geral_total += ($row_transacoes['valor_anuidade']) + ($row_transacoes['valor_mensalidade']);
...
<h3 style="text-align: center;">RELATÓRIO GERAL VALORES - 2024</h3>
