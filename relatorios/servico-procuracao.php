...
-->
                        ...
                        <p align=justify style="line-height: 150%; margin-left: 15; margin-right: 15"><b>OUTORGANTE</b> '.utf8_decode($cliente->nome).', natural de '.utf8_decode($cliente->naturalidade).', '.utf8_decode($cliente->nacionalidade).', '.utf8_decode($cliente->estadocivil).', CPF nº: '.formataCPFCNPJ($cliente->cpf).', Identidade nº '.utf8_decode($cliente->identidade).', '.utf8_decode($cliente->orgaouf).', nascido em  '.date('d/m/Y', strtotime($cliente->data_nascimento)).', filho de '.utf8_decode($cliente->pai).' e '.utf8_decode($cliente->mae).', residente à rua '.utf8_decode($cliente->endereco).', Cep: '.utf8_decode($cliente->cep).', '.utf8_decode($cliente->cidade).'/'.utf8_decode($cliente->siglauf).'.</p>
...
<p align=center><font size=2>
_____________________________________________<br><b>Outorgante:</b> '.utf8_decode($cliente->nome).'<br><b>
