...
$html .= '<th bgcolor="#CCCCCC" width="15%"><div align="center">D.FILIAÇÃO</th>';
$html .= '<th bgcolor="#CCCCCC" width="15%"><div align="center">D.RENOVAÇÃO</th>';
$html .= '</tr>';
$html .= '</thead>';
$html .= '<tbody>';

$result_transacoes = "SELECT * FROM tab_membros WHERE bloqueio LIKE 'D' order by matricula";
...
while ($row_transacoes = mysqli_fetch_assoc($resultado_trasacoes)) {
    ...
    $html .= '<td width="15%"><div align="center"><font size="1">' . date('d/m/Y', strtotime($row_transacoes['data_filiacao'])) . '</td>';
    $html .= '<td width="15%"><div align="center"><font size="1">' . date('d/m/Y', strtotime($row_transacoes['data_renovacao'])) . '</td>';
    $html .= '</tr>';
...
<h3 style="text-align: center;">RELA&Ccedil;&Atilde;O DE MEMBROS DESFILIADOS</h3>
