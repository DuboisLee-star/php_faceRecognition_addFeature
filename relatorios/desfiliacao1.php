...
'.PDF_TEXTO.' DECLARA, para fim de comprovação junto ao Exército Brasileiro, que o Sr(a) <B>'.mb_strtoupper($cliente->nome).'</b>, CR nº <B>'.$cliente->cr.'</b>, CPF nº: <B>'.formataCPFCNPJ($cliente->cpf).'</b>, requereu a <b>DESFILIAÇÃO</b> na data de '.PDF_DATADESFILIA.'.</p><br>
