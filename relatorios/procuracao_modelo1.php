...
<b>'.utf8_decode($procurador2->nome).'</b>, '.utf8_decode($procurador2->estadocivil).', '.utf8_decode($procurador2->nacionalidade).', residente e domiciliado na '.utf8_decode($procurador2->rua).' n&#x00B0; '.utf8_decode($procurador2->numero).', bairro: '.utf8_decode($procurador2->bairro).', Cep: '.utf8_decode($procurador2->cep).', Cidade '.utf8_decode($procurador2->cidade).'/'.utf8_decode($procurador2->siglauf).', CPF n&#x00B0; '.utf8_decode($procurador2->cpf).', Identidade '.utf8_decode($procurador2->identidade).'</br>.</p>

<p align=justify style="line-height: 150%; margin-left: 15; margin-right: 15"><b>PODERES</b> Outorgando-lhe(s) os poderes necess&#x00E1;rios para representar-me junto ao Ex&#x00E9;rcito Brasileiro - SERVI&#x00C7;O DE FISCALIZA&#x00C7;&#x00C3;O DE PRODUTOS CONTROLADOS - 7&#x00AA; REGI&#x00C3;O MILITAR, a fim de atender disposi&#x00E7;&#x00F5;es contidas na legisla&#x00E7;&#x00E3;o em vigor, conferindo, ainda, ao dito OUTORGADO poderes especiais para, em nome do(a) outorgante, requerer, assinar e encaminhar Atestado de Antecedentes Criminais, Certid&#x00F5;es, e documentos referente a Concess&#x00E3;o de CR, Renova&#x00E7;&#x00E3;o de CR, Transfer&#x00EA;ncia entre Acervos, Transfer&#x00EA;ncia de Armas, Apostilamentos, CRAFs, Guia de Tr&#x00E1;fego, solicita&#x00E7;&#x00E3;o para Aquisi&#x00E7;&#x00E3;o de Armas, Pedido de Andamento de Processo, Pedido de Rean&#x00E1;lise, Retirar Documentos, Desarquivar Processos, Desistir de Requerimento - atender of&#x00ED;cios, receber e atender intima&#x00E7;&#x00F5;es, acompanhar a fiscaliza&#x00E7;&#x00E3;o para vistoria t&#x00E9;cnica militar, pedir, assinar e requerer vistas de processos, bem como, retirar os mencionados documentos qu
