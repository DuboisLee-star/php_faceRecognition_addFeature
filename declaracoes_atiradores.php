...
<!-- Botão Declaração de Habitualidade Inicial -->
<div class="btn-group btn-group-sm">
  <a class="btn btn-info btn-sm custom-btn" href="relatorios/habitualidade.php?id=<?php echo $row['id']; ?>" title="Dec. Hab. Inicial" target="_blank">
    <i class="fa fa-file-text-o" aria-hidden="true"></i>&nbsp;DHI</a>
</div>
