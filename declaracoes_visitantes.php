  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <div class="nav search-row" id="top_menu">
        ...
        {
        $.ajax({
        url:"ajax_p_declaracoes_visitantes.php",
        method:"POST",
        data:{query:query},
...
<form method='post' action=""><input type="submit" class="btn btn-danger btn-sm" value="SAIR" name="but_logout"></form>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-tasks" aria-hidden="true"></i>Declarações Visitantes</h3>
            <ol class="breadcrumb">
  ...
  <script>
      const delUsers = (id_usuario) => {
          ...
          if(r){
            window.location="action_del_habitu.php?id="+id_usuario;
            return true;
          }
          return false;
      }
