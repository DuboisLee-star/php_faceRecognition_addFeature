...
<td>
  ...
  <td><?php echo !empty($renova) ? $renova : ''; ?></td>
  <td><?php echo $dias; ?></td>
  ...
  <td>
    ...
    <!-- Botão Armas -->
    <div class="btn-group btn-group-sm">
      <a class="btn btn-info btn-sm" href="armas.php?id=<?php echo $row['id']?>&matricula=<?=$row['matricula']?>" Title="Armas" alt="Armas"><i class="fa fa-hand-o-right" aria-hidden="true"></i></a>
    </div>
