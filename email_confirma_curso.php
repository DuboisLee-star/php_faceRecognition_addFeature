			...
			<?php else: ?>
					...
					<div class="row">
				      	...
				      	<div class="col-md-2">
						    <a href="#" class="thumbnail">
						      <img src="'.URL_painel.'/fotos/<?=$cliente->foto?>" height="190" width="150" id="foto-cliente">
						    </a>
					  	</div>
				  	</div>
					...
					function enviaEmail(){
						...
						<div class="form-group">
							...
							<textarea class="form-control" rows="6" name="msg_email" id="msg_email"><br><img src="'.URL_painel.'/img/logo_site.png" height="90"><br><br>

Olá <b><?=$cliente->nome?></b>

Este &eacute; um email autom&aacute;tico para informar que sua inscri&ccedil;&atilde;o no Curso <b><?= $cliente->curso; ?></b> no Clube de Tiro foi recebida. Acompanhe o status <b><?= $cliente->status; ?></b>.

Depois de confirmado procure informações na secretaria do clube.
