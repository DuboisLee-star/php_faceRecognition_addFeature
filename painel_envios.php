...
<form method='post' action=""><input type="submit" class="btn btn-danger btn-sm" value="SAIR" name="but_logout"></form>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-tasks" aria-hidden="true"></i>Painel de Envios</h3>
...
?>
<td>
  <img src="fotos/<?php echo htmlspecialchars($foto); ?>" class="img-responsive img-thumbnail" style="width: 30px; height: 30px; object-fit: cover;" />
</td>
...
<td>
  <div class="btn-group" role="group">
    <input class="form-check-input" type="radio" id="envios_auto_<?php echo $row['id']; ?>" name="envios_auto_<?php echo $row['id']; ?>" value="1" <?php if($row['envios_auto'] == "1") echo 'checked'; ?>>
    <label class="form-check-label" for="envios_auto_<?php echo $row['id']; ?>">Ativar</label>

    <input class="form-check-input" type="radio" id="envios_auto_<?php echo $row['id']; ?>" name="envios_auto_<?php echo $row['id']; ?>" value="0" <?php if($row['envios_auto'] == "0") echo 'checked'; ?>>
    <label class="form-check-label" for="envios_auto_<?php echo $row['id']; ?>">Desativar</label>
  </div>
</td>
</tr>
</tbody>
