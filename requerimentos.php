...
<form method='post' action=""><input type="submit" class="btn btn-danger btn-sm" value="SAIR" name="but_logout"></form>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div   class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-tasks" aria-hidden="true"></i>REQUERIMENTOS</h3>
            <ol style="overflow-y: scroll; display: scroll" class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="painel.php">Home</a></li>
				<li><i class="fa fa-table"><a href="painel.php"></i>Ativos</li></a> | <a href="painel_inativos.php"></i>Inativos</li></a> | <a href="painel_todos.php"></i>Todos</li></a> | <a href="painel_convidados.php"></i>Convidados</li></a> | <a href="painel_visitantes.php"></i>Visitantes</li></a>
            </ol></font>
          </div>
        </div>
        <!-- page start-->
   ...
   <a class="btn btn-info btn-sm" href="requerimento_gerar.php?id='.$row["id"].'" >SELECIONAR</a>
   </div>
