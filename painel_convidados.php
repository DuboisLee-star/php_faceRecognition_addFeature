...
$query = "SELECT a.* 
FROM tab_membros a 
LEFT JOIN tab_habitualidade h ON h.matricula = a.matricula
WHERE h.tipo_atirador LIKE '%3%' 
...
$total_query = "SELECT COUNT(*) as total FROM tab_habitualidade WHERE tipo_atirador LIKE '%3%'";
        ...
        <div class="row">
          <div class="col-lg-12">
            <section class="panel">
              ...
              <thead>
              <tr>
              <th><i class="icon_profile column_sort" id="nome" data-order="desc"></i> Nome convidado</th>
              <th><i class="icon_calendar column_sort "></i> Cidade</th>
...
{ 
    ...
    if ($dias < 0) {
        ...
        $dias = $dias . " dias restantes";
              ...
              <td><?php echo strtoupper($row["nome_convidado"]); ?></td>
              <td><?php echo '.$row["cidade_convidado"].' ?></td>

  
  <td>
    <div class="btn-group btn-group-sm">
   <a class="btn btn-info btn-sm" href="perfil_convidado.php?id='.$row["id"].'" Title="Editar" alt="Editar"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
   </div>

  <div class="btn-group btn-group-sm">
  <a class="btn btn-info btn-sm" href="javascript:void(0);" onclick="return delUsers(\'' . $row['id'] . '\');" data-confirm="Excluir registro?"><i class="fa fa-trash-o fa-fw" aria-hidden="true"></i></a>
  </div>
</td>
