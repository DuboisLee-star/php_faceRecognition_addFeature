...
$total_query = "SELECT COUNT(*) as total FROM tab_membros WHERE bloqueio LIKE '%D%'";
...
{ 
    ...
    if ($dias < 0) {
        ...
        $dias = $dias . " dias restantes";
              ...
              <tbody>
              <tr>
              <td><img src="fotos/<?php echo htmlspecialchars($row['foto']); ?>" class="img-responsive img-thumbnail" style="width: 30px; height: 30px; object-fit: cover;" /></td>
