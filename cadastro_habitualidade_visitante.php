                ...
                <tbody>
                  ...
                  <tr>	
                   <td>Data Inicial do Evento</td>
                    <td><input type="date" class="form-control" id="data_inicial_visitante" name="data_inicial_visitante" value=""></td>
                  </tr>
                  <tr>   
                   <td>Data Final do Evento</td>
                    <td><input type="date" class="form-control" id="data_final_visitante" name="data_final_visitante" value=""></td>
                  </tr>
                  <tr>                   
                    ...
                    <tr>
                     ...
                     <tr>
                      ...
                      <td>
                        ...
                        <span class='msg-erro msg-pontos'></span>
                        <br>
                        <button type="button" id="add-line-pontos">+</button>
                        <div id="dynamic-fields-pontos"></div>
                      </td>
                    </tr>
                     <tr>
                      <td>Classificação</td>
                      <td>
                        ...
                        <span class='msg-erro msg-classificacao'></span>
                        <br>
                        <button type="button" id="add-line-classificacao">+</button>
                        <div id="dynamic-fields-classificacao"></div>
                      </td>
                    </tr>
                </tbody>
              </table>
             ...
             buttonModalidade.addEventListener('click', function () {
                ...
                newLineModalidade.innerHTML = `
                    <div>
                        ...
                        <input type="text" class="form-control" id="numsigma{countModalidade}" name="modalidade[]">
             ...
             buttonNumSigma.addEventListener('click', function () {
                ...
                newLineNumSigma.innerHTML = `
                    <div>
                        ...
                        <input type="text" class="form-control" id="numsigma${countSigma}" name="numsigma[]">
                        <button type="button" class="remove-field">-</button>
                    </div>
                `;
