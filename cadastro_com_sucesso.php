  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-user" aria-hidden="true"></i>Cadastro efetuado com sucesso!</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i>Cadastro de Novos Membros</li>
        ...
        <!-------------------------------------------------------------------------------------------------------------- page start-->
				    ...
				    <button class="btn btn-info"><a href="cadastro_novo.php"><font color="White">Fazer um novo cadastro</font></a></button>
                      </form>
              		</fieldset>					  
