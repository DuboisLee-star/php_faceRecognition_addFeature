...
$id_financeiro = (isset($_GET['id'])) ? $_GET['id'] : '';

// Valida se existe um id e se ele é numérico
if (!empty($id_financeiro) && is_numeric($id_financeiro)):
    ...
    <fieldset>
            ...
            <div class="panel-group m-bot20" id="accordion">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title">
                   ...
                   <i class="icon_calendar"></i>&nbsp;<?= date('d-m-Y', strtotime($financeiro->data_pgto))?>
                    </a>
                    </h4>
                    </div>
                    <div id="collapseTwos">
                ...
                <tbody>
                  ...
                  <tr>
                   ...
                   <td>
                    ...
                    <input type="number" class="form-control mb-2" id="valor_a_pagar" name="valor" style="width: 300px;" placeholder="Valor" value="<?=$financeiro->valor?>" readonly>
                        <label for="valor_mensalidade">Valor pago:</label>
                    <input type="number" class="form-control mb-2" id="valor_mensalidade" step=".01" name="valor_pago" style="width: 300px;" placeholder="Valor" value="">
                    ...
                    <label for="">Número de parcelas:</label>
                       <select name="n_parcela" class="form-control mb-2" style="width: 300px;" disabled>
                           
                        <option value="<?=$financeiro->n_parcela?>" selected><?=$financeiro->n_parcela?></option>
                        <?php for($i=1;$i<13;$i++){?>
              ...
              <!--collapse start-->
				...
				<button type="submit" class="btn btn-primary" id='botao'>Dar Baixa</button>
