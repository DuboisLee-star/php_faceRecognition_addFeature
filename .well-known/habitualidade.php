...
?>
        ...
        function updateLinks() {
            ...
            linkTodosCalibres.forEach(function(link2) {
              ...
              <div class="btn-group btn-group-sm">
                <a class="dropdown-item" id="todoscalibres" href="#" target="_blank">TODOS CALIBRES1</a>
              </div>
              <script>
        document.getElementById('todoscalibres').addEventListener('click', function(event) {
            ...
            var url = `relatorios/habitualidadeTodosCalibres.php?id=${clienteId}&datainicial=${datainicial}&datafinal=${datafinal}`;
