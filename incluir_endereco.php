...
function salva(){
	...
	var segundo_rua = document.getElementById("segundo_rua").value;
	var segundo_num = document.getElementById("segundo_num").value;
	var segundo_bairro = document.getElementById("segundo_bairro").value;
	var segundo_cep = document.getElementById("segundo_cep").value;
	var segundo_cidade = document.getElementById("segundo_cidade").value;
	var segundo_estado = document.getElementById("segundo_estado").value;
	var segundo_obs = document.getElementById("segundo_obs").value;
	
	if(segundo_rua == ""){alert("Preencha o campo Rua."); return false;}
	if(segundo_num == ""){alert("Preencha o campo Num."); return false;}
	if(segundo_bairro == ""){alert("Preencha o campo Bairro."); return false;}
	if(segundo_cep == ""){alert("Preencha o campo CEP."); return false;}
	if(segundo_cidade == ""){alert("Preencha o campo Cidade."); return false;}
	if(segundo_estado == ""){alert("Preencha o campo Estado."); return false;}
	if(segundo_obs == ""){alert("Preencha o campo OBS."); return false;}
...
<fieldset>
		...
		<legend></legend>
			...
			<?php else: ?>
				<form action="action_incluirendereco.php" method="post" id='form-contato' enctype='multipart/form-data'>
					<div class="row">
