  ...
  <?php include 'menu_lateral_esq.php';?>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-envelope" aria-hidden="true"></i><?=$cliente->nome?></h3>
            <ol class="breadcrumb">
          ...
          <div class="col-lg-12">
              <b>Atirador:</b>
              <select class="form-control select2" onchange="window.location='email.php?id='+this.value">
                  <?php if($atiradores): ?>
