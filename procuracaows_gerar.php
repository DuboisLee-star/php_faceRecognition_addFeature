...
<div style="margin-bottom: 15px;">
	...
	<div class="panel">
		...
		<table style="margin-top: 0 !important" width="100%" cellspacing="1" cellpadding="5" bgcolor="#cccccc" class="table table-bordered">
			<tr>
				<td colspan="2" bgcolor="#f0f0f0" align="center"><b>Selecione um procurador</b></td>
			</tr> 
	...
	<div class="panel">
		<table style="margin-top: 0 !important" width="100%" cellspacing="1" cellpadding="5" bgcolor="#cccccc" class="table table-bordered">
			...
			<tr>
				...
				<td bgcolor="#f0f0f0" align="center" width="30"><input class="checkbox" type="checkbox" name="arma4" id="arma4_b" value="<?=$cliente->id?>"></td>
				<td bgcolor="#ffffff"><?=$cliente->apelido?></td>
			</tr>
			<?php endforeach;?> 
...
$(document).ready(function(){             
  ...
  var testval2 = [];
    ...
    document.getElementById("imprimir2").href = "/relatorios/procuracao_modelo2.php?id=<?= $id_cliente; ?>&a="+testval2.join('&f=');
 });
