...
<?php include 'menu_lateral_esq.php';?>
    ...
    <fieldset>
				...
				<form action="action_cadastro_curso.php" method="post" id='form-contato' enctype='multipart/form-data'>
					<div class="row">
					<label for="nome">Selecionar Foto</label>
			      	<div class="col-md-2">
					    <a href="#" class="thumbnail">
					      <img src="https://www.clubetirocarcara.com.br/fotos/padrao.jpg" height="190" width="150" id="foto-cliente">
					    </a>
				  	</div>
            ...
            <section class="panel">
			  ...
			  <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>Whatsapp</td>
                    <td><input type="text" class="form-control" id="whatsapp" name="whatsapp" value=""></td>
                 </tr>
                  <tr>
                    <td>Email</td>
              ...
              <div class="panel-body">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type="radio" name="curso_basico" id="curso_basico" value="Curso Básico" <?php if($cliente->curso_basico == "Curso Básico") echo ' checked '; ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="curso_especializado" id="curso_especializado" value="Curso Especializado" <?php if($cliente->curso_especializado == "Curso Especializado") echo ' checked '; ?>></td>
                  </tr>
                </tbody>
              </table>
            </section>
				...
				<button type="submit" class="btn btn-info" id='botao'>Inscrever no Curso</button>
                </form>
              	</fieldset>					  
