...
if($act == "envia" && $msg_email && $email && $nome && $assunto_email){
	...
	//REMETENTE --> ESTE EMAIL TEM QUE SER VALIDO DO DOMINIO
 	//====================================================
	$email_remetente = "contatos@clubetirocarcara.com.br"; // deve ser um email do dominio
	//====================================================
	...
	exit();
	*/
	$email_reply = "contatos@clubetirocarcara.com.br";
...
<fieldset>
			...
			<?php else: ?>
					...
					<div class="row">
				      	...
				      	<div class="col-md-2">
						    <a href="#" class="thumbnail">
						      <img src="https://www.clubetirocarcara.com.br/fotosvisitas/<?=$cliente->foto?>" height="190" width="150" id="foto-cliente">
						    </a>
					  	</div>
				  	</div>
					...
					<input value="C&oacute;d. Acesso para Visitante | CTC" type="text" class="form-control" name="assunto_email" id="assunto_email">
					<span class='msg-erro msg-nome'></span>
					</div>
					<div class="form-group">
					<label for="email">Mensagem do e-mail:</label>
					<textarea class="form-control" rows="6" name="msg_email" id="msg_email">

<table align="left" background="https://www.clubetirocarcara.com.br/img/autorizacao.png" style="padding-top:82px;" width="505" height="721">
	<tr>
		<td align="center" width="50%" valign="top">
		<br>
		<div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=3><b><?=$cliente->nome_visita?></b></font><br>
		<div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=3><b><?=$cliente->convidado_por?></b></font><br>
		<div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=3><b><?=$cliente->autorizacao?></b> para <b><?=date('d/m/Y', strtotime($cliente->data_visita));?></b></font><br>
		<div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=3><b><font size=5>[SENHA_MEMBRO]</font></b><br>
</td>
	</tr>
		<tr>
		<td valign="top">&nbsp;</td>
