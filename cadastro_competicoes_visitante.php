...
<?php include 'menu_lateral_esq.php';?>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-user" aria-hidden="true"></i>COMPETIÇÕES VISITANTE</h3>
            <ol class="breadcrumb">
    ...
    <fieldset>
				...
				<form name="cadastro" action="action_cadastro_competicoes_visitante.php" method="post" id='form-contato' enctype='multipart/form-data'>
					<div class="row">
