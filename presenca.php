...
<body>
    <section id="container" class="">
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><i class="fa fa-camera"></i> Captura Foto Presente</h3>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form action="action_face_presenca.php" method="post" id="form-photo">
                                    <div class="row">
                                        <div class="col-md-2">
    ...
    <script>
        ...
        document.getElementById("form-photo").addEventListener("submit", function (event) {
            ...
            fetch("action_face_presenca.php", {
                method: "POST",
                body: formData
            })
