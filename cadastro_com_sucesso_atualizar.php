  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-user" aria-hidden="true"></i>CADASTRO ATUALIZADO!</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i>Atualização de Cadastro</li>
