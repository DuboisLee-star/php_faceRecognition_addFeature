    ...
    <section id="main-content">
      <section class="wrapper">
		...
		<fieldset>
			...
			<?php else: ?>
				<form action="action_edit_adm.php" method="post" id='form-contato' enctype='multipart/form-data'>
                ...
                <tbody>
                  ...
                  <tr>
                   <td>Administrador</td>
                    <td><input type="text" class="form-control" id="name" name="name" value="<?=$cliente->name?>" disabled></td>
                  </tr>
                  <tr>
                    <td>Nome Acesso</td>
                    <td><input type="text" class="form-control" id="username" name="username" value="<?=$cliente->username?>" disabled></td>
                  </tr>
                  <tr>
                    <td>Nova Senha</td>
                  ...
                  <tr>
                    ...
                    <td> <input type="hidden" name="user" value="<?=$_SESSION['uname']?>">
