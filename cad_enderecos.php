...
<form method='post' action=""><input type="submit" class="btn btn-danger btn-sm" value="SAIR" name="but_logout"></form>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-building-o" aria-hidden="true"></i>Endere&ccedil;o</h3>
            <ol class="breadcrumb">
            ...
            <section class="panel">
			  ...
			  <?php if(!empty($clientes)):?>
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      <td><img src='https://www.clubetirocarcara.com.br/fotos/<?=$cliente->foto?>' height='30' width='30'></td>
                      <td <?php if((int)$cliente->senha_enviada == 0){echo ' style="color: red;" ';} ?>><?=$cliente->nome?></td>
					  <td>
<div class="btn-group btn-group-sm">
<a class="btn btn-info btn-sm" href='mudar_endereco.php?id=<?=$cliente->id?>' alt="Editar">Mudar Endere&ccedil;o</a>
</div>

<div class="btn-group btn-group-sm">
<a class="btn btn-info btn-sm" href='incluir_endereco.php?id=<?=$cliente->id?>' alt="Editar">Incluir Endere&ccedil;o </a>
</div>
